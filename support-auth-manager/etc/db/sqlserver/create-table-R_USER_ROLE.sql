...
/****** Object:  Table [dbo].[R_USER_ROLE]    Script Date: 11/23/2016 10:19:49 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [dbo].[R_USER_ROLE] ADD  CONSTRAINT [DF_R_USER_ROLE_IS_DELETED]  DEFAULT ('N') FOR [IS_DELETED]
GO
